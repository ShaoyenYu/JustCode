...
from techstacks.auto_game.games.azur_lane.interface.scene.base import Scene, goto_scene_main, auto_retry
from techstacks.auto_game.games.azur_lane.interface.scene.name import Namespace
from techstacks.auto_game.util.game_cv import match_multi_template, combine_similar_points
from techstacks.auto_game.util.game_cv.ocr import ocr_int, ocr_preprocess
