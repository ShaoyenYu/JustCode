...
from techstacks.auto_game.games.azur_lane.interface.scene.base import Scene, goto_scene_main, ocr_paddle, auto_retry
from techstacks.auto_game.games.azur_lane.interface.scene.name import Namespace
from techstacks.auto_game.util.game_cv import slice_image, binarize, find_most_match
