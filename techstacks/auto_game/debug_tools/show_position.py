...
from util.win32.window import parse_rbg_int2tuple
...
class PixelDetector:
    ...
    def update_pixel_info(cls):
        ...
        rgb_tuple = parse_rbg_int2tuple(rgb_int) if rgb_int is not None else None
...
class PausableThread(Thread):
    ...
    def run(self) -> None:
        while True:
            ...
            try:
                PixelDetector.update_pixel_info()
                PixelDetector.tell_pixel_info()
